...
// https://developer.wordpress.org/reference/classes/wp_query/#author-parameters
  ...
  'author__in'      =>  [2, 6],     // (array) - use author id (available since Version 3.7).
  'author__not_in'  =>  [2, 6],     // (array)' - use author id (available since Version 3.7).
...
// https://developer.wordpress.org/reference/classes/wp_query/#post-page-parameters
  ...
  'title'                   =>  'Hello World',          // (string) - use post title (available since Version 4.4)
  ...
  'post_parent__in'         =>  [1,2,3],                // (array) - use post ids. Specify posts whose parent is in an array. (available since Version 3.6)
...
// https://developer.wordpress.org/reference/classes/wp_query/#password-parameters
  'has_password'    =>   true,          // (bool) - available since Version 3.9 - true for posts with passwords - false for posts without passwords - null for all posts with and without passwords
  'post_password'   =>  'multi-pass',   // (string) - show posts with a particular password (available since Version 3.9)
...
//https://developer.wordpress.org/reference/classes/wp_query/#pagination-parameters
    'posts_per_page'    =>  10,                     // (int) - number of post to show per page (available since Version 2.1). Use 'posts_per_page' => -1 to show all posts.
